        ...
        <input type="hidden" name="id" value="<?php echo $dataCliente['id']; ?>">
            ...
            <div class="modal-body" id="cont_modal">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="departamento" class="form-control" value="<?php echo $dataCliente['departamento']; ?>" required="true">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="text" name="cedula" class="form-control" value="<?php echo $dataCliente['cedula']; ?>" required="true">
                </div>
                 <div class="form-group">
                  <label for="recipient-name" class="col-form-label">Serie:</label>
                  <input type="number" name="serie" class="form-control" value="<?php echo $dataCliente['serie']; ?>" required="true">
                </div>

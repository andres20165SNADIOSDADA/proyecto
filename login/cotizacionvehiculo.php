        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="segurovida.php">Seguro de vida</a>
...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-10 col-lg-10 bg-light form-demo rounded mt-5" >
                <h1 class="text-center text-dark">COTIZACIÓN DE SEGURO DE VEHICULO</h1>
                ...
                <table class="table table-dark table-striped">
                    ...
                    <tbody>
                     <?php 
						$consulta = "SELECT * FROM seguro WHERE id=3";

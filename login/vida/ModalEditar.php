            ...
            <div class="modal-body" id="cont_modal">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input type="number" name="cedula" class="form-control" value="<?php echo $dataCliente['cedula']; ?>" required="true">
                </div>
                 <div class="form-group">
                  <label for="recipient-name" class="col-form-label">Estrato:</label>
                  <input type="number" name="estrato" class="form-control" value="<?php echo $dataCliente['estrato']; ?>" required="true">
                </div>
